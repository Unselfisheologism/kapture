package dev.dect.scrnshoot.model;
...
public class Scrnshoot {
    private final String TAG = Scrnshoot.class.getSimpleName();
    ...
    public Scrnshoot(Context ctx) {
        this(ctx, -1, "", null, null, null, FROM_PHONE);
    }

    public Scrnshoot(Context ctx, File file) {
        this(ctx, -1, file.getAbsolutePath(), null, null, null, FROM_PHONE);
    }

    public Scrnshoot(Context ctx, long id, String location, ArrayList<Extra> extras, ArrayList<Screenshot> screenshots, String profileId, String from) {
        this.CONTEXT = ctx;
        this.ID = id;
    ...
    public void addExtra(Extra extra) {
        if(extra.getIdScrnshoot() == -1) {
            extra.setIdScrnshoot(this.ID);
        }
    ...
    public void addScreenshot(Screenshot screenshot) {
        if(screenshot.getIdScrnshoot() == -1) {
            screenshot.setIdScrnshoot(this.ID);
        }
    ...
    public static boolean isFromWatch(Scrnshoot scrnshoot) {
        return scrnshoot.getFrom().equals(FROM_WATCH);
    }
    ...
    public static class Extra {
        ...
        public Extra(long id, int type, String location, long idScrnshoot) {
            this.ID = id;
            this.TYPE = type;
            this.LOCATION = location;
            this.ID_KAPTURE = idScrnshoot;
        }
        ...
        public void setIdScrnshoot(long idScrnshoot) {
            this.ID_KAPTURE = idScrnshoot;
        }
    ...
    public static class Screenshot {
        ...
        public Screenshot(long id, String location, long idScrnshoot) {
            this.ID = id;
            this.LOCATION = location;
            this.ID_KAPTURE = idScrnshoot;
        }
