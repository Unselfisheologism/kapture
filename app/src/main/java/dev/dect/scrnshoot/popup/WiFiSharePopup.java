package dev.dect.scrnshoot.popup;
...
import dev.dect.scrnshoot.server.KSecurity;
import dev.dect.scrnshoot.utils.Utils;
import dev.dect.scrnshoot.view.KStaticViewPager;
...
public class WiFiSharePopup extends Dialog {
    ...
    public void setAmount(int amount) {
        ((TextView) VIEW.findViewById(R.id.title)).setText(CONTEXT.getString(R.string.popup_wifi_share_title) + " " + amount + " " + CONTEXT.getString(amount == 1 ? R.string.scrnshoot : R.string.scrnshoot_plural));
    }
