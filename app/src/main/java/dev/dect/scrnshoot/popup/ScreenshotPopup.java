...
import dev.dect.scrnshoot.adapter.ScreenshotItemAdapter;
...
public class ScreenshotPopup extends Dialog {
    ...
    public ScreenshotPopup(Context ctx, ArrayList<Scrnshoot.Screenshot> screenshots, @Nullable Runnable btnClose) {
