...
package dev.dect.scrnshoot.notification;
...
import dev.dect.scrnshoot.activity.ActionActivity;
import dev.dect.scrnshoot.activity.viewer.VideoActivity;
...
public class CapturedNotification {
    ...
    public void createAndShow(Scrnshoot scrnshoot) {
        ...
        final int id = (int) scrnshoot.getId();
        ...
        try {
            ...
            mediaMetadataRetriever.setDataSource(scrnshoot.getLocation());
        ...
        iPlay.putExtra(VideoActivity.INTENT_URL, scrnshoot.getLocation());
        ...
        if(scrnshoot.hasExtras()) {
            ...
            iExtra.putExtra(ActionActivity.INTENT_KAPTURE_ID, scrnshoot.getId());
            ...
            iShare.putExtra(ActionActivity.INTENT_KAPTURE_ID, scrnshoot.getId());
        ...
        iDelete.putExtra(ActionActivity.INTENT_KAPTURE_ID, scrnshoot.getId());
