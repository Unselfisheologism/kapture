...
public class ListStorage {
    ...
    public static class Adapter extends RecyclerView.Adapter<Adapter.MyViewHolder> {
        ...
        public Adapter(Context ctx, boolean isLastFromGroup) {
            ...
            this.ITEMS.add(new ListStorage.StorageItem(R.color.storage_scrnshoots, R.string.storage_scrnshoots, 0));
        ...
        public void updateValues(Context ctx) {
            final long storageTotal = ctx.getFilesDir().getTotalSpace(),
                       ...
                       storageScrnshoots = KFile.getAppTotalFilesSize(ctx, false),
                       storageCache = KFile.getCacheSize(ctx);

            ITEMS.get(0).setValue(storageTotal - storageFree - storageScrnshoots - storageCache);
            ITEMS.get(1).setValue(storageScrnshoots);
