...
public class ExtraItemAdapter extends RecyclerView.Adapter<ExtraItemAdapter.MyViewHolder> {
    private final ArrayList<Scrnshoot.Extra> EXTRAS;

    private final ExtraPopup POPUP;

    public ExtraItemAdapter(ArrayList<Scrnshoot.Extra> extras, @Nullable ExtraPopup popup) {
        this.EXTRAS = extras;
        this.POPUP = popup;
    }
    ...
    public void onBindViewHolder(@NonNull ExtraItemAdapter.MyViewHolder holder, int position) {
        ...
        final Scrnshoot.Extra extra = EXTRAS.get(position);
