...
import dev.dect.scrnshoot.adapter.FragmentAdapter;
import dev.dect.scrnshoot.ads.AdManager;
...
import dev.dect.scrnshoot.notification.ReceivingNotification;
import dev.dect.scrnshoot.popup.DialogPopup;
import dev.dect.scrnshoot.popup.PermissionPopup;
...
public class MainActivity extends AppCompatActivity {
    ...
    private ScrnshootsFragment KAPTURE_FRAGMENT;
    ...
    private void initVariables() {
        ...
        KAPTURE_FRAGMENT = new ScrnshootsFragment();
    }
    ...
    public void requestUiUpdate(Scrnshoot scrnshoot) {
        KAPTURE_FRAGMENT.updateUI(scrnshoot);
    }

    public ScrnshootsFragment getScrnshootFragment() {
