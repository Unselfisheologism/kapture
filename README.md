...
Scrnshoot is built over an accessibility service, turning it into a specific case, like mentioned <a href="https://developer.android.com/media/platform/sharing-audio-input#accessibility_service_ordinary_app" target="_blank" rel="noreferrer">here</a> in the android docs.
...
<ol>
  ...
  <li>Tap <b>Apps</b>;</li>
  <li>
    Tap the app that you want to turn on a restricted setting for (Scrnshoot);
    <ul>
...
³ Link to all phone versions (>= 1.5.0) can be found <a href="https://github.com/hms-douglas/scrnshoot/blob/master/dist/all.json" target="_blank" rel="noreferrer">here</a> and to all watch versions <a href="https://github.com/hms-douglas/scrnshoot/blob/master/dist/all_watch.json" target="_blank" rel="noreferrer">here</a>;
</br>
  ...
  <tr>
    <td valign="top">
      ...
      <ul>
         ...
         <li>Back to top button added to scrnshoots screen;</li>
